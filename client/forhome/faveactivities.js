...
//  var favlink = `http://localhost:8000/forhome/favoriteslist.html?userEmail=`+encodeURIComponent( userEmail);
...
function redirectTOAbout(activityName) {
    ...
    window.location.href= addactivityLink;
    // window.location.href= "http://localhost:8000/forhome/activitydetail.html"
}
